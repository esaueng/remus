...
Fidelity evidence: [STEP round-trip audit 2026-09-18](step-roundtrip-audit-2026-09-18.md) — all 31 `crates/io/tests/data/*.step` fixtures through import → export → import (face counts, FaceSurface/EdgeCurve histograms, volume/area at 0.01 deflection); 28 exact, 3 findings with `#[ignore]` ready-repros.
