...
is in implementation: native and packaged WASM quarter-wall resizing and refusal
tests pass; full-workspace verification is pending. General partial
walls and journaled direct-edit completion remain open.
