...
**Reconciled:** 2026-09-18 against `main` at `3785eebcede74113f4b5b04fa6d884ae4a580127`.
...
| --- | --- | --- |
| 1 — Correctness and proof | Qualify the B26 ready-repro rows (B32–B44, B46, B47) one owner row at a time; land the in-flight un-ignore of five closed repros (#500). | #410/#413/#416/#417 closed 2026-09-13, superseded by merged #422. Tests-only campaigns must retain minimized failures rather than silently turn into kernel fixes. |
...
| 3 — Geometry | P-Class 2.4 integration qualification and 2.5's named curved-NURBS slices; remaining 2.6/2.7 cells; B7/B8 as their witnesses require. | #416 closed 2026-09-13; the 2.5 repair rides merged #422. B4's four planar gaps landed in #398; its curved-face refusal remainder belongs with M5, not another planar-trimmer rewrite. Serialize GFA/splitter work. |
| 4 — Interactive performance | B28 / PERF-N04: qualify the landed fused NURBS evaluation and the landed scratch and in-flight budget slices. Then extend profiles (PERF-M04/M05/M07), calibrate gates (PERF-M03), and select one measured cost. | #411 is landed; #418 is merged; #413 closed 2026-09-13 (carried by merged #422). Preserve source/package provenance and numerical behavior. O3.1a already provides a maintained baseline; extend it. |
...
Snapshot from GitHub on 2026-09-18. Re-fetch before claiming or changing any row.
...
| --- | --- | --- |
| [#500](https://github.com/esaueng/remus/pull/500) | B26 un-ignore of five closed repros (B35/B42/B44 Done, B39 partial) | `8446598e26cc` |
| [#499](https://github.com/esaueng/remus/pull/499) | CI fleet-fuzz pin to its main-reachable squash commit | `c3aeee5fb7cd` |
| [#493](https://github.com/esaueng/remus/pull/493) | transform certificate budget-scale slack | `23a77cec3c73` |
...
[#463](https://github.com/esaueng/remus/pull/463) (merged 2026-09-17; its CI `Test` failure was the pre-existing `revolve_orientation_holds_across_scales`
scale assertion, which failed identically on unmodified `main` and passed at
the fix head — not a regression from the fix).
