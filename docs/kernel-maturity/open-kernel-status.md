...
| O1.1c Gauntlet CI wiring | A | Complete — nightly smoke and weekly abc-1k schedules publish reproducible aggregate scoreboards and append-only per-stage trends; a 0.50pp drop fails while still publishing the red aggregate | — |
