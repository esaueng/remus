...
- P2.8 SSI marcher-budget WASM surface — CLOSED 2026-09-02 in this change: direct quality/cancellation and batch quality booleans expose the existing march/queue/segment/branch caps with default, boundary, rejection, generated-WASM, and rollback contracts; parameter-space tolerance and wider operation adoption remain in `docs/kernel-maturity/p-class-status.md`.
