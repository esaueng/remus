...
- P4.2 body-class validation substrate — PARTIAL 2026-09-03 in PR #209: RFC 0005 Stage 1 adds public body-class tags, class-aware solid/sheet/wire validation with stable diagnostics, and backward-compatible optional arena-v3 fields. Standalone sheet roots and L3/STEP/WASM entry points remain for later tranches; the substrate alone promotes no capability cell.
