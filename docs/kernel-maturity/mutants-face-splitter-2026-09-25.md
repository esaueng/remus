...
- **Filed — [B61](roadmap.md#b61).** Found while pinning the collar's lid
...
- **Filed — [B62](roadmap.md#b62).** The collar's classification sample
  ...
  into B61's wrong result, so it waits on B61. Ready-repros in both test
  files named above.
