...
| 4.4 Trim sheet by solid / sheet × sheet | Partial, in review — keep-inside/keep-outside sheet-by-solid trimming returns a new validated Sheet with native/direct/batch WASM parity; the planar crossing witness has exact 100/96 area oracles and coincident patches refuse typed, while mutual sheet×sheet trim and the trim-plus-sew exit witness remain | [#215](https://github.com/esaueng/remus/pull/215) |
| 4.5 Imprint | Pending | — |
