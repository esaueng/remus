...
| 2.3 Steinmetz ellipses | In review — perpendicular equal-radius cylinder×cylinder intersection retains six analytic cylinder patches on eight authoritative ellipse arcs, matches `16/3·r³`, and passes native, manifold-mesh, census, and WASM exact-only gates | — |
