...
| 2.0c Reader migration and seam-safe validation | In progress — strict-domain foundation and producer normalization merged; four reader tranches remove 70 readers (98 → 28 current), leaving 27 tessellation and 1 topology-validation reader | [#154](https://github.com/esaueng/remus/pull/154) + [#159](https://github.com/esaueng/remus/pull/159) + [#162](https://github.com/esaueng/remus/pull/162) + [#165](https://github.com/esaueng/remus/pull/165) + [#169](https://github.com/esaueng/remus/pull/169) |
