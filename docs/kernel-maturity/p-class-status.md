...
| 2.8 OperationContext budgets and cancellation | Partial — boolean/SSI cancellation plus coupled SSI Newton and recursive seed-subdivision budgets complete; parameter-space budgets and wider adoption remain | [PR #138](https://github.com/esaueng/remus/pull/138) + [PR #147](https://github.com/esaueng/remus/pull/147) + this PR |
