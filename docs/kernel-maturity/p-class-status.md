...
| 5.6 Face-face blends and hold lines | Implemented, in review — disjoint-edge convex planar face selections with transversal carriers produce a new validated exact cylindrical Sheet; a prescribed complete contact segment is verified analytically, with scale/translation, independent area, direct/batch WASM, and transactional typed-refusal witnesses. Multi-face, curved/holed-support, partial-hold, and support-trimming cells remain unqualified | — |
