...
| 2.0c Reader migration and seam-safe validation | Complete — the staged reader migration is at zero (132 → 0), and CI strictly validates both oriented cylinder-seam pcurves on an exact boolean output with non-vacuous counts | [#154](https://github.com/esaueng/remus/pull/154) + [#159](https://github.com/esaueng/remus/pull/159) + [#162](https://github.com/esaueng/remus/pull/162) + [#165](https://github.com/esaueng/remus/pull/165) + [#169](https://github.com/esaueng/remus/pull/169) + [#172](https://github.com/esaueng/remus/pull/172) + this PR |
