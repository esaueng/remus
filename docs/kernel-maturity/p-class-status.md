...
| 5.5 Overflow and cliff handling | Implemented — v2 fillets stop transactionally at planar support boundaries, inner-loop obstacles, closed-rim wall exhaustion, paired bands consuming one wall, and inward cap collapse with typed edge/face/requested/available metadata and stable native/WASM parity; actual rollover remains unqualified pending 6.1 | [#234](https://github.com/esaueng/remus/pull/234) |
