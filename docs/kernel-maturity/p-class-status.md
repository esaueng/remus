...
| 4.6 Multi-region boolean output | Partial, in review — exact two-solid booleans return a Compound of independently validated regions with deterministic cavity assignment and total per-region construction lineage; severing cut and disjoint fuse witnesses pass natively and through direct/batch WASM, while Compound operands and legacy helper retirement remain | [#218](https://github.com/esaueng/remus/pull/218) |
