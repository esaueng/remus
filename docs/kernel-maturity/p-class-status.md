...
| 2.0c Reader migration and seam-safe validation | In progress — the staged reader migration is complete (132 → 0); non-vacuous SameParameter/SameRange validation over boolean outputs remains | [#154](https://github.com/esaueng/remus/pull/154) + [#159](https://github.com/esaueng/remus/pull/159) + [#162](https://github.com/esaueng/remus/pull/162) + [#165](https://github.com/esaueng/remus/pull/165) + [#169](https://github.com/esaueng/remus/pull/169) + [#172](https://github.com/esaueng/remus/pull/172) |
