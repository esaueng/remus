...
| 2.1 Honest-failure hygiene | In review — part 1 names unsupported phase-FF pairs; part 2 makes every pcurve UV-projection fallback and its face-splitter callers fail with a pinned diagnostic instead of substituting zero or a NURBS midpoint | [#129](https://github.com/esaueng/remus/pull/129) + [#194](https://github.com/esaueng/remus/pull/194) |
