...
| 2.0e Physical Loop/Coedge p-curve authority | In review — Face boundary order and per-use pcurve/winding storage are authoritative Loop/Coedge state; arena v3 round-trips both seam branches while v1/v2 derive them compatibly | — |
