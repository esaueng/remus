...
| 2.3 Steinmetz ellipses | In review — perpendicular equal-radius cylinder intersection retains the exact Steinmetz ellipse carriers and passes closed-form volume, manifold, classification, and WASM gates | [#205](https://github.com/esaueng/remus/pull/205) |
| 2.4 Quadric × quadric transversal | Partial, in review — bounded sphere arrangement cells preserve transversal sphere×sphere regions, and torus×box complement selection retains the exact torus band; general periodic NURBS splitting and the rest of the quadric matrix remain | [#206](https://github.com/esaueng/remus/pull/206) + [#207](https://github.com/esaueng/remus/pull/207) |
