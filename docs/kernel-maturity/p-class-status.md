...
| 4.2 Sheet bodies first-class | Partial, in review — Stage 1 supplies body-class tags, validation, diagnostics, and additive arena-v3 fields; the operations tranche adds transactional construction, area, typed volume refusal, open tessellation, and direct/batch WASM; arena v4 adds standalone sheet roots with exact authority replay and frozen v3 writer bytes. Bounding box, center-of-area, and STEP remain | [#209](https://github.com/esaueng/remus/pull/209) + [#210](https://github.com/esaueng/remus/pull/210) + [#211](https://github.com/esaueng/remus/pull/211) |
