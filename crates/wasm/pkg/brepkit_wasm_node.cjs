...
class BrepKernel {
     ...
     * @param {PersistentRefV1} reference
     * @returns {PersistentRefResolutionV1}
     */
    resolvePersistentRef(reference) {
        const ret = wasm.brepkernel_resolvePersistentRef(this.__wbg_ptr, reference);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_error_f9bdac4c0b4e0785: function(arg0, arg1) {
        ...
        __wbg_log_ec0bb1af9c6701a8: function(arg0, arg1) {
        ...
        __wbg_warn_f1728d2785e70aeb: function(arg0, arg1) {
