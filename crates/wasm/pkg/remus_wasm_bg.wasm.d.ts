...
export const __wbg_operationcancellationtoken_free: (a: number, b: number) => void;
...
export const brepkernel_addRefDiscriminator: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
...
export const brepkernel_booleanWithQuality: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number) => [number, number, number];
...
export const brepkernel_deserializeWire: (a: number, b: number, c: number) => [number, number, number];
export const brepkernel_deserializeWires: (a: number, b: number, c: number) => [number, number, number, number];
...
export const brepkernel_exportGlbMulti: (a: number, b: number, c: number, d: number) => [number, number, number, number];
...
export const brepkernel_exportObjMulti: (a: number, b: number, c: number, d: number) => [number, number, number, number];
...
export const brepkernel_exportStepSheet: (a: number, b: number, c: number, d: number) => [number, number, number, number];
...
export const brepkernel_filletJournaled: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
...
export const brepkernel_getEdgeParamSpan: (a: number, b: number) => [number, number, number, number];
...
export const brepkernel_getFaceCurvature: (a: number, b: number, c: number, d: number) => [number, number, number];
export const brepkernel_getFaceEdges: (a: number, b: number) => [number, number, number, number];
export const brepkernel_getFaceMinRadius: (a: number, b: number) => [number, number, number];
export const brepkernel_getFaceName: (a: number, b: number) => [number, number, number, number];
...
export const brepkernel_importStepBodies: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
...
export const brepkernel_importStepWithValidation: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number, number];
export const brepkernel_importStl: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const brepkernel_imprint: (a: number, b: number, c: number) => [number, number, number, number];
...
export const brepkernel_journalBarrier: (a: number, b: number, c: number, d: number) => [number, number, number];
export const brepkernel_journalSummary: (a: number) => [number, number];
...
export const brepkernel_linearPatternJournaled: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
...
export const brepkernel_makeOperationOutputRef: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
...
export const brepkernel_makeSheetBody: (a: number, b: number, c: number) => [number, number, number];
...
export const brepkernel_serializeSheets: (a: number, b: number, c: number) => [number, number, number, number];
...
export const brepkernel_serializeWire: (a: number, b: number) => [number, number, number, number];
export const brepkernel_serializeWires: (a: number, b: number, c: number) => [number, number, number, number];
export const brepkernel_setFaceName: (a: number, b: number, c: number, d: number) => [number, number];
...
export const brepkernel_sheetArea: (a: number, b: number, c: number) => [number, number, number];
export const brepkernel_sheetBoundingBox: (a: number, b: number) => [number, number, number, number];
...
export const brepkernel_splitBySheet: (a: number, b: number, c: number) => [number, number, number];
...
export const brepkernel_sweepWire: (a: number, b: number, c: number) => [number, number, number];
...
export const brepkernel_tessellateSheet: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
...
export const operationcancellationtoken_cancel: (a: number) => void;
export const operationcancellationtoken_isCancelled: (a: number) => number;
export const operationcancellationtoken_new: () => number;
