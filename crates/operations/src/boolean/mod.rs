...
pub use brepkit_algo::gfa::{EdgeEvent, EntityEvolution, VertexEvent};
...
/// surface of [`brepkit_algo::gfa::boolean_with_entity_evolution`].
///
...
pub fn boolean_with_entity_evolution(
    ...
    Ok(brepkit_algo::gfa::boolean_with_entity_evolution(
