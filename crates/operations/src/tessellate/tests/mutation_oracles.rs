...
/// Ready-repro (B63): with the densification capped to its budget, the
...
#[test]
#[ignore = "open: B63 — budget-capped trim rows still sag past 2× deflection beside a line trim"]
...
/// Ready-repro (B64): the torus notch with the box turned 25° or 30° about x
...
#[test]
#[ignore = "open: B64 — steeply turned torus notch meshes open at fine deflection"]
