...
pub(super) fn tessellate_torus_two_rim_band(
    ...
    let (d0, d1) = crate::authoritative_edge_domain(seam_edge, "torus band seam")?;
...
mod interior_grid_limit_tests {
    ...
    use super::{
        MAX_INTERIOR_GRID_POINTS, validate_interior_grid_size, validate_stepped_rim_level_count,
    };
