...
/// B62: with the walls close under the lid the collar's classification
/// sample (the lid latitude nudged a fixed amount toward the equator) lands
/// beyond a wall, in a wall cap.
#[test]
#[ignore = "open: B62 — collar interior sample overshoots a wall close under the lid"]
fn b62_collar_sample_stays_inside_walls_close_under_the_lid() {
    for rad in [2.0, 50.0] {
