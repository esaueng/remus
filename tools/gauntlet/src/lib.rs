...
fn check_id_code(check: CheckId) -> &'static str {
    match check {
        ...
        CheckId::ShellFreeBoundary => "shell_free_boundary",
        CheckId::ShellOrientationConsistent => "shell_orientation_consistent",
        CheckId::SheetOrientationConsistent => "sheet_orientation_inconsistent",
        CheckId::BodyClassResolved => "body_class_unresolved",
