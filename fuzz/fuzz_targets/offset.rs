...
//!   (edges/corners) while catching collapse-to-nothing and
//!   doubled-boundary inflation. One-sided by design: offsets may grow
...
//! collapse without refusing, or inflate through doubled boundaries.
//!
