...
- O1.1a gauntlet pipeline — CLOSED 2026-08-30 in this PR: isolated bounded workers and all five stages are pinned under `tools/gauntlet`; manifests/fetching and CI remain O1.1b/c.
