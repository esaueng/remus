...
- P2.8 SSI Newton budget — CLOSED 2026-08-30: `WorkBudgets::newton_iterations` governs all coupled SSI refinements and cancellation is polled inside the loop; subdivision and parameter-space budgets remain in `docs/kernel-maturity/p-class-status.md`.
