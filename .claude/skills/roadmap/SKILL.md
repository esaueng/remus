...
- O1.1d gauntlet triage loop — PARTIAL 2026-09-01 (1/5 classes, this PR): generic period-winding STEP bands reconstruct exact analytic seams or refuse transactionally; `crates/io/tests/step_generic_face_bound_order.rs` pins MAMBO B12, and smoke moved `invalid_input` 14→10 / full passes 26→29.
