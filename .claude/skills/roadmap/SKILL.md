...
- [ ] **Head-to-head timing at least parity** (the brepjs wasm bench; see
      `parity-benchmarking`).
- [ ] **Release published** when user-facing (see the production-readiness release checklist).
...
`fillet-blend` (the blend traps), plus the production-readiness release checklist for a user-facing close.
